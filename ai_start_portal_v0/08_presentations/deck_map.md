...
- снять сопротивление;
- объяснить, что это не "курс про нейросети";
...
1. AI Start: рабочая система для редакционных задач.
2. Что обычно ломается в случайных чатах.
3. Пять пайплайнов программы.
4. AI-hub: где что лежит.
5. A1/A2/A3.
6. Правило: AI drafts, human owns.
7. Как будет устроена каждая встреча.
8. Что надо сделать до следующего блока.
