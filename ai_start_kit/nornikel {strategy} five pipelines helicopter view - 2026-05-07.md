...
```text
source
-> EXO / извлечение фактов и смыслов
-> context
-> tone of voice
-> style graph
-> repurpose map
...
- `EXO`: extraction layer, где материал разбирается на факты, смыслы, цитаты, риски, недостающий контекст;
...
- EXO: извлечение фактов, смыслов, цитат, рисков;
