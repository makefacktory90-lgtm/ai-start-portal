const modules = {
  ...
  radar: {
    ...
    insights: [
      "Аудио полезно только вместе с проверкой фактов, ритма, произношения и ограничений сервиса.",
      "Музыкальный промпт нужно оценивать на результате, а не по формулировке в чате.",
      "Редакторский контур начинается с материалов и сигналов, а не с интерфейса инструмента."
    ]
  },
  system: {
    crumb: "Pipeline 05",
